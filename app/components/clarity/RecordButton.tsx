...
export function RecordButton({ status, onStart, onStop }: RecordButtonProps) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`inline-flex h-14 min-w-[8rem] items-center justify-center gap-2 rounded-full px-8 text-sm font-bold shadow-md ring-2 transition disabled:opacity-50 ${
        isRecording
